...
router.get('/info-cliente', authenticate, verifyType(['cliente', 'instructor']), verifyRole(['instructor']), getInfoClient);
...
router.put('/cambiar-contrasena', authenticate, verifyType(['cliente', 'instructor']), verifyRole(['instructor']), changeContrasenaClient);
router.put('/cambiar-correo', authenticate, verifyType(['cliente', 'instructor']), verifyRole(['instructor']), changeCorreoClient);
