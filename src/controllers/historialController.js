...
const createRecord = async (areaId, tipoEntidad, entidadId, adminId, clienteId, clienteNombre, elementoId, descripcion, Cantidad, Observaciones, Estado, Accion, Archivo = null) => {
    try{
